...
export const INITIAL_FLEET_CONFIG = {
  "3.8 米": { "max_kg": 3000, "slots": 6, "cost_base": 300, "cost_km": 1.5 },
  "4.2 米": { "max_kg": 4000, "slots": 8, "cost_base": 350, "cost_km": 1.8 },
  "6.8 米": { "max_kg": 10000, "slots": 14, "cost_base": 500, "cost_km": 2.5 },
  "9.6 米": { "max_kg": 18000, "slots": 20, "cost_base": 800, "cost_km": 3.5 },
  "12.5 米": { "max_kg": 28000, "slots": 28, "cost_base": 1200, "cost_km": 4.5 },
  "13.5 米": { "max_kg": 32000, "slots": 32, "cost_base": 1500, "cost_km": 5.0 },
  "17.5 米": { "max_kg": 40000, "slots": 40, "cost_base": 2000, "cost_km": 6.0 }
};

export const ICONS = {
  Truck: () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 18V6a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v11a1 1 0 0 0 1 1h2"/><path d="M15 18H9"/><path d="M19 18h2a1 1 0 0 0 1-1v-3.65a1 1 0 0 0-.22-.624l-2.235-2.794A1 1 0 0 0 17.065 9H15"/><path d="M17 9V5a2 2 0 0 0-2-2h-3"/><circle cx="7" cy="18" r="2"/><circle cx="17" cy="18" r="2"/></svg>
  ),
  FileUp: () => (
